...
/**
 * combines the two lists into one list of tuples of containing paired values from the two lists
 * 
 ...
 * @param predicate predictate to test
 * @returns number of times predicate returns true for the elements of the xs
 */
