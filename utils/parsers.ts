...
/**
 * creates a new parser that only parses a specific character
 ...
 * @returns new parser that succeeds only for a specific string
 */
...
/**
 * consumes all whitespace characters until a nonwhitespace character or emtpy string is encountered
 */
